//
//  QuickLoanIdentityCardUploadingVC.m
//  短借宝
//
...
#import "QuickLoanIdentityCardUploadingVC.h"

@interface QuickLoanIdentityCardUploadingVC ()<UINavigationControllerDelegate,UIImagePickerControllerDelegate,UIActionSheetDelegate>
...
@implementation QuickLoanIdentityCardUploadingVC

- (void)viewDidLoad {
    [super viewDidLoad];
    
    NSData *ss=[NSData dataWithContentsOfFile:[NSString stringWithFormat:@"%@/Documents/image21.png",NSHomeDirectory()]];
...
-(void)imagePickerController:(UIImagePickerController*)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    if ([type isEqualToString:(NSString *)kUTTypeImage])
    {
        ...
        [fileManager createFileAtPath:[DocumentsPath stringByAppendingString:@"/image21.png"] contents:_data attributes:nil];
