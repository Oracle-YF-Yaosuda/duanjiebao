//
//  QuickLoanStudentIdentityCardUploadingVC.m
//  短借宝
//
...
#import "QuickLoanStudentIdentityCardUploadingVC.h"

@interface QuickLoanStudentIdentityCardUploadingVC ()<UINavigationControllerDelegate,UIImagePickerControllerDelegate,UIActionSheetDelegate>
...
@implementation QuickLoanStudentIdentityCardUploadingVC

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    NSData *ss=[NSData dataWithContentsOfFile:[NSString stringWithFormat:@"%@/Documents/image2.png",NSHomeDirectory()]];
