...
- (void)viewDidLoad {
    ...
    _weixin.contentSize=CGSizeMake(320, 2750);
...
//    UILabel *ll8=[[UILabel alloc] initWithFrame:CGRectMake(10, 190, width-20, 20)];
//    ll8.text=@"以免造成还款失败";
...
//    [_weixin addSubview:ll8];
    ...
    UIImageView *img=[[UIImageView alloc] initWithFrame:CGRectMake(0, 180, width, 2500)];
