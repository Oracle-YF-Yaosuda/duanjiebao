...
//    }
    ...
    scl.contentSize=CGSizeMake(width, 2640);
    ...
    ll1.text=@"1、 短借宝的借款方只接受持有中华人民共和国有效身份证明的18周岁以上具有完全民事行为能力的自然人，且同时为全日制高等院校在校生的用户。短借宝的贷款方接受持有中华人民共和国有效身份证明的18周岁以上具有完全民事行为能力的自然人，并有合法的财产来源。资格不符，请勿注册，否则短借宝有权随时中止或终止您的用户资格。\n2、短借宝是一个线上申请、审批、放款的互联网借款平台。用户在注册成功并提交必要真实、有效的材料及信息后，即可申请线上的借款。到期只需将应还款转入还款账户，即可完成还款。操作便捷、迅速，安全可靠。\n3、用户在使用短借宝之前，必须在短借宝完成注册，用户按照提示，填写用户名、身份证，所属院校、所属院系、学生证照片、学生证号、密码、实名登记的手机号码即可完成注册，成为短借宝用户。用户须填写准确的联系方式，尤其是手机号码，以便及时接收动态验证密码，享受后续服务。\n4、用户要确保个人资料信息的真实性、完整性和有效性，并承诺对个人资料信息及时进行更新。若因用户未提供有效联系方式，导致本公司未能提供或错误提供服务，造成的损失及法律后果，由用户自行承担。\n5、使用过程中，若用户出现逾期还款时，短借宝会根据规定征收逾期违约金和逾期罚金。\n6、用户应当妥善保管密码及所绑定的手机号码，密码或手机动态密码配对成功的，视为当事人本人的实际操作，并由当事人本人承担全部法律后果。";
    ll1.numberOfLines=0;
    [ll1 sizeToFit];
    ...
    ll2.text=@"1、短借宝为用户提供的服务包括但不限于：受理用户的借款申请、进行交易管理、还款提醒等。具体内容以短借宝当前版本实际提供的服务内容为准。\n2、短借宝受理用户的借款申请，只有经过身份认证的用户，才能享受借款服务。若因用户未完成身份认证或注册失败导致的无法接受在线服务，短借宝不承担任何责任。\n3、短借宝为用户提供交易管理服务，包括借款资金的发放，还款资金、手续费、服务费等必要费用的扣划。用户使用短借宝，即视为用户同意短借宝进行借款的扣放款服务，短借宝应及时将扣放款的情况以短信、页面或电子邮件等展现等形式告知用户。\n4、短借宝有权根据需要不时地修改本须知正文各条款或制定、修改各短借宝规则并在短借宝相关系统板块发布，无需另行单独通知。若用户在本须知知正文相关条款和/或短借宝规则内容公告变更后继续使用短借宝网站及/或短借宝APP服务的，表示已充分阅读、理解并接受修改后的内容，也将遵循修改后的本须知正文条款和/或短借宝规则使用短借宝的服务。\n5、 用户通过自行或授权有关方根据本须知及短借宝有关规则、说明操作确认本须知后，本须知即在您和短借宝之间产生法律效力。您在此同意将全面接受和履行与短借宝其他用户在短借宝签订的任何电子法律文本，并承诺按该等法律文本享有和/或放弃相应的权利、承担和/或豁免相应的义务。";
    ll2.numberOfLines=0;
    [ll2 sizeToFit];
